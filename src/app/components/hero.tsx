...
export default function HeroSection({ className }: { className?: string }) {
  return (
    ...
    >
      <AudioVisualiser className="absolute inset-0 -z-10 group-hover:scale-110 transition-scale duration-120 ease-out" />
      <div className="bg-dark-alt/20 w-full h-full p-8 relative z-10 flex flex-col items-start justify-between">
        <h2>New Release</h2>
        <h3 className="font-bold text-4xl">100% Ólafur Arnalds</h3>
        <div className="flex gap-2 items-center">
          <Image src="/users.png" alt="2,355 fans" width={64} height={20} />
          <svg
            width="16"
            height="16"
            viewBox="0 0 16 16"
